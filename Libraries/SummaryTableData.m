...
% INIZIALIZZAZIONE
    ...
    SummaryTable.VanillaNumber(1) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "VANILLA"))); 
    SummaryTable.BarrierNumber(1) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "BARRIER"))); 
    SummaryTable.BinaryNumber(1) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "BINARY"))); 
    SummaryTable.LookbackNumber(1) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "LOOKBACK"))); 
...
if size(PortfolioData,1) > 1    
   ...
   SummaryTable.NetPosition(i) = sum(TempQ(TempCurrency == Currency));
    ...
    SummaryTable.VanillaNumber(i) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "VANILLA"))); 
    SummaryTable.BarrierNumber(i) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "BARRIER"))); 
    SummaryTable.BinaryNumber(i) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "BINARY"))); 
    SummaryTable.LookbackNumber(i) = sum(TempQ(TempOptionType(TempCurrency == Currency & TempOptionType == "LOOKBACK")));  
